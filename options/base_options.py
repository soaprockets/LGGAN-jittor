...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='jittor', help='name of the experiment. It decides where to store samples and models')
        ...
        # for setting inputs
        parser.add_argument('--dataroot', type=str, default='../jittor_landscape_200k/train/')
        ...
        # for generator
        parser.add_argument('--netG', type=str, default='lggan', help='selects model to use for netG (lggan | pix2pixhd | spade)')
